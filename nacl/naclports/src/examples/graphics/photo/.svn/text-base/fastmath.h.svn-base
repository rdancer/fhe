...
#ifndef PHOTO_FASTMATH_H_
#define PHOTO_FASTMATH_H_
...
// Magic constants used for various floating point manipulations.  These assume
// a 32-bit processor architecture and the IEEE-794 floating point
// representation.
...
// Union to switch from float to int and back without changing the bits.  This
// asumes that an int32_t and a float are both 32-bits.
union Reinterpret {
  int32_t i;
  float f;
};
