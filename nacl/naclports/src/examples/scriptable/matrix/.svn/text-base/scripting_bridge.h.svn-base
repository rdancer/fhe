...
#ifndef EXAMPLES_SCRIPTABLE_MATRIX_SCRIPTING_BRIDGE_H_
#define EXAMPLES_SCRIPTABLE_MATRIX_SCRIPTING_BRIDGE_H_
...
NPClass* ScriptingBridge::GetNPSimpleClass() {
  printf("ScriptingBridge::GetNPSimpleClass was called!\n");
  fflush(stdout);
...
NPObject* ScriptingBridge::AllocateCallback(NPP npp, NPClass* npclass) {
  printf("ScriptingBridge::Allocate was called!\n");
  fflush(stdout);
  ...
  printf("ScriptingBridge::Allocate returning a bridge!\n");
  fflush(stdout);
  return bridge;
}


#endif  // EXAMPLES_SCRIPTABLE_MATRIX_SCRIPTING_BRIDGE_H_
